...
namespace QReduction.Infrastructure.Migrations
{
    ...
    [Migration("20210128143937_JobRequestParameters")]
    partial class JobRequestParameters
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QReduction.Core.Domain.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QReduction.Core.Domain.JobRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QReduction.Core.Domain.JobRequestParameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QReduction.Core.Domain.ShiftUserView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("QReduction.Core.Domain.JobRequest", b =>
                {
                    b.HasOne("QReduction.Core.Domain.Job", "Job")
            ...
            modelBuilder.Entity("QReduction.Core.Domain.JobRequestParameter", b =>
                {
                    b.HasOne("QReduction.Core.Domain.JobRequest", "JobRequest")
                        .WithMany("JobRequestParameters")
